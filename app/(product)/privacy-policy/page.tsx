  ...
  return (
    ...
    >
      <div className="flex flex-col gap-6 w-full items-center">
        <ProductLegalNavbar />
        <div className="lg:max-w-[340px] flex lg:justify-center w-full">
...
*   **Application** refers to CVCompass, the software program provided by the Company.
    
*   **Company** (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to CVCompass.
...
*   By email: iam.paulsayantan06@gmail.com
    
*   By visiting this page: [https://sayantanpaul.com/](https://sayantanpaul.com/)`;
